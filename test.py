...
def _process_image_files(name, filenames, labels, num_shards, num_threads):
...
def _process_image_files_batch(coder, thread_index, ranges, name, filenames,
  ...
  for s in range(num_shards_per_batch):
    ...
    output_file = os.path.join(name, output_filename)
...
if __name__ == '__main__':
    ...
    _process_image_files(args.name, filenames, labels, args.num_shards, args.num_threads)
