...
def task_face_feature_extraction(filelist, taskPath, net, transformer, dim, imageSize_h, imageSize_w,  blob_name, isColor):
    ...
    feature_batch = np.zeros((num, 1920))
    i = 0
    while True:
	i = i + 1
	line = file.readline()
...
if __name__ == "__main__":
    ...
    args = parse_args()
    test_dataPath = "/home/zeng/data4my_dirtywork/id_rgb_160/"
    #test_dataPath = "/home/zeng/data4my_dirtywork/center_224/"
