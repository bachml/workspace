...
def extract_feature(net, transformer, filelist, dimension, imageSize):
    ...
    while 1:
        ...
        net.blobs['data'].reshape(1, 3, 224, 192)
        net.blobs['data'].data[...] = transformer.preprocess('data', caffe.io.resize_image(caffe.io.load_image('id_test_224x192/' + imagePath, color=True),(224,192)))
        out = net.forward()
        feat = net.blobs['prob'].data[0] # 'fc160' is the layer name in caffemodel, edit this arguments base on your own model
