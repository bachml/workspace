...
def extract_feature(net, transformer, filelist, dimension, imageSize, data_folder):
    ...
    while 1:
        ...
        net.blobs['data'].data[...] = transformer.preprocess('data', caffe.io.resize_image(caffe.io.load_image(data_folder + imagePath, color=True),(224,224)))
        out = net.forward()
        feat = net.blobs['fc2'].data[0] # 'fc2048' is the layer name in caffemodel, edit this arguments base on your own model
...
if __name__ == "__main__":
    ...
    data_folder = "/home/zeng/data4my_dirtywork/center_224/"
    ...
    outputFileName = data_folder + "_extra.npy"
    print(feature.shape)
    np.save(outputFileName, feature)
