...
def show_accracy(folder, intradist_path, extradist_path):
...
if __name__ == "__main__":
    ...
    #show_accracy(folder_path, 'GFace7.1_dist_intra.npy', 'GFace7.1_dist_extra.npy')
    #show_accracy(folder_path, 'cos_lfw_cos_dist_intra.npy', 'cos_lfw_cos_dist_extra.npy')
    #show_accracy(folder_path, 'cos_lfw_l2_dist_intra.npy', 'cos_lfw_l2_dist_extra.npy')
    #show_accracy(folder_path, 'cos_lfw_regl2_dist_intra.npy', 'cos_lfw_regl2_dist_extra.npy')
    #show_accracy(folder_path, 'cos_lfw_bc_dist_intra.npy', 'cos_lfw_bc_dist_extra.npy')
