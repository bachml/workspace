...
def extract_feature(net, transformer, filelist, dimension, imageSize):
    ...
    while 1:
        ...
        net.blobs['data'].data[...] = transformer.preprocess('data', caffe.io.resize_image(caffe.io.load_image('id_test_112x96/' + imagePath, color=True),(112,96)))
        out = net.forward()
